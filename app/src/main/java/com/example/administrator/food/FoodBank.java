...
public class FoodBank extends AppCompatActivity implements
    ...
    private FourthFragment fourthFragmen;
    private List<Fragment> mFragmentList = new ArrayList<Fragment>();
    private FragmentAdapter mFragmentAdapter;

    String[] titles = new String[]{"碳水化合物", "蛋白质", "维生素矿物质", "脂肪"};
    ...
    private void initViews() {
        ...
        fourthFragmen = new FourthFragment();
        //给FragmentList添加数据
        mFragmentList.add(oneFragment);
        mFragmentList.add(twoFragment);
        mFragmentList.add(threeFragment);
        mFragmentList.add(fourthFragmen);
    }
    ...
    private void changeTextColor(int position) {
        if (position == 0) {
            item_weixin.setTextColor(Color.parseColor
                    ("#66CDAA"));
            item_tongxunlu.setTextColor(Color.parseColor
                    ("#FFFFFF"));
            item_faxian.setTextColor(Color.parseColor
                    ("#FFFFFF"));
            item_me.setTextColor(Color.parseColor
                    ("#FFFFFF"));
        } else if (position == 1) {
            item_tongxunlu.setTextColor(Color.parseColor
                    ("#66CDAA"));
